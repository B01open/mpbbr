...
Ptr<OutputStreamWrapper> sfcwnd1;
Ptr<OutputStreamWrapper> sfcwnd2;
Ptr<OutputStreamWrapper> sfcwnd3;
Ptr<OutputStreamWrapper> sfcwnd4;
Ptr<OutputStreamWrapper> sfcwnd5;
Ptr<OutputStreamWrapper> sfcwnd6;
Ptr<OutputStreamWrapper> sfcwnd7;
Ptr<OutputStreamWrapper> sfcwnd8;
Ptr<OutputStreamWrapper> sfcwnd9;

Ptr<OutputStreamWrapper> sfcwnd11;
Ptr<OutputStreamWrapper> sfcwnd12;
Ptr<OutputStreamWrapper> sfcwnd13;
Ptr<OutputStreamWrapper> sfcwnd14;
Ptr<OutputStreamWrapper> sfcwnd15;
Ptr<OutputStreamWrapper> sfcwnd16;
Ptr<OutputStreamWrapper> sfcwnd17;
Ptr<OutputStreamWrapper> sfcwnd18;
Ptr<OutputStreamWrapper> sfcwnd19;

Ptr<OutputStreamWrapper> sfTotalCwnd;

int iSegSize = 476;

std::string dir = "results-sfcwnd/";
std::string cwnddirToSave = "mkdir -p " + dir;
    ...
    m_multipleSubflows(false)
{
  ...
  system (cwnddirToSave.c_str ());

  AsciiTraceHelper asciisfcwnd1;
  std::string sfcwndTrFileName1 = dir + "sf-cwnd1";
  sfcwnd1 = asciisfcwnd1.CreateFileStream (sfcwndTrFileName1.c_str ());

  AsciiTraceHelper asciisfcwnd2;
  std::string sfcwndTrFileName2 = dir + "sf-cwnd2";
  sfcwnd2 = asciisfcwnd2.CreateFileStream (sfcwndTrFileName2.c_str ());

  AsciiTraceHelper asciisfcwnd3;
  std::string sfcwndTrFileName3 = dir + "sf-cwnd3";
  sfcwnd3 = asciisfcwnd3.CreateFileStream (sfcwndTrFileName3.c_str ());

  AsciiTraceHelper asciisfcwnd4;
  std::string sfcwndTrFileName4 = dir + "sf-cwnd4";
  sfcwnd4 = asciisfcwnd4.CreateFileStream (sfcwndTrFileName4.c_str ());

  AsciiTraceHelper asciisfcwnd5;
  std::string sfcwndTrFileName5 = dir + "sf-cwnd5";
  sfcwnd5 = asciisfcwnd5.CreateFileStream (sfcwndTrFileName5.c_str ());

  AsciiTraceHelper asciisfcwnd6;
  std::string sfcwndTrFileName6 = dir + "sf-cwnd6";
  sfcwnd6 = asciisfcwnd6.CreateFileStream (sfcwndTrFileName6.c_str ());

  AsciiTraceHelper asciisfcwnd7;
  std::string sfcwndTrFileName7 = dir + "sf-cwnd7";
  sfcwnd7 = asciisfcwnd7.CreateFileStream (sfcwndTrFileName7.c_str ());

  AsciiTraceHelper asciisfcwnd8;
  std::string sfcwndTrFileName8 = dir + "sf-cwnd8";
  sfcwnd8 = asciisfcwnd8.CreateFileStream (sfcwndTrFileName8.c_str ());

  AsciiTraceHelper asciisfcwnd9;
  std::string sfcwndTrFileName9 = dir + "sf-cwnd9";
  sfcwnd9 = asciisfcwnd9.CreateFileStream (sfcwndTrFileName9.c_str ());

  AsciiTraceHelper asciisfcwnd11;
  std::string sfcwndTrFileName11 = dir + "sf-cwnd11";
  sfcwnd11 = asciisfcwnd11.CreateFileStream (sfcwndTrFileName11.c_str ());

  AsciiTraceHelper asciisfcwnd12;
  std::string sfcwndTrFileName12 = dir + "sf-cwnd12";
  sfcwnd12 = asciisfcwnd12.CreateFileStream (sfcwndTrFileName12.c_str ());

  AsciiTraceHelper asciisfcwnd13;
  std::string sfcwndTrFileName13 = dir + "sf-cwnd13";
  sfcwnd13 = asciisfcwnd13.CreateFileStream (sfcwndTrFileName13.c_str ());

  AsciiTraceHelper asciisfcwnd14;
  std::string sfcwndTrFileName14 = dir + "sf-cwnd14";
  sfcwnd14 = asciisfcwnd14.CreateFileStream (sfcwndTrFileName14.c_str ());

  AsciiTraceHelper asciisfcwnd15;
  std::string sfcwndTrFileName15 = dir + "sf-cwnd15";
  sfcwnd15 = asciisfcwnd15.CreateFileStream (sfcwndTrFileName15.c_str ());

  AsciiTraceHelper asciisfcwnd16;
  std::string sfcwndTrFileName16 = dir + "sf-cwnd16";
  sfcwnd16 = asciisfcwnd16.CreateFileStream (sfcwndTrFileName16.c_str ());

  AsciiTraceHelper asciisfcwnd17;
  std::string sfcwndTrFileName17 = dir + "sf-cwnd17";
  sfcwnd17 = asciisfcwnd17.CreateFileStream (sfcwndTrFileName17.c_str ());

  AsciiTraceHelper asciisfcwnd18;
  std::string sfcwndTrFileName18 = dir + "sf-cwnd18";
  sfcwnd18 = asciisfcwnd18.CreateFileStream (sfcwndTrFileName18.c_str ());

  AsciiTraceHelper asciisfcwnd19;
  std::string sfcwndTrFileName19 = dir + "sf-cwnd19";
  sfcwnd19 = asciisfcwnd19.CreateFileStream (sfcwndTrFileName19.c_str ());


  AsciiTraceHelper asciisftotalcwnd;
  std::string sftotalcwndTrFileName = dir + "sf-total-cwnd";
  sfTotalCwnd = asciisftotalcwnd.CreateFileStream (sftotalcwndTrFileName.c_str ());
...
//  schedulerTypeId = MpTcpSchedulerAverageRTT::GetTypeId();
...
void
MpTcpSocketBase::AddSubflowCwndRecord()
{
...
MpTcpSocketBase::SendPendingData(bool withAck)
{
  ...
  while(m_scheduler->GenerateMapping(subflowArrayId, dsnHead, length))
  {
    ...
    //yqy add sf cwnd statistic
    statisticSingleFlowCwnd(subflowArrayId);

    //yqy
   // coupledSingleFlowCwnd(subflowArrayId);
...
/*
  ...
  for (uint32_t i = 0; i < 1; i++)   //Maximum
  {
    for( SubflowList::const_iterator it = m_subflows[i].begin(); it != m_subflows[i].end(); it++ )
    {
      Ptr<MpTcpSubflow> sf = *it;
  ...
  for (int i = 0; i < (int) GetNActiveSubflows() ; i++ )
      {
        Ptr<MpTcpSubflow> sf = GetSubflow(i);
        	   ...
        	   if(i == 0){
        		   	   *sfcwnd1->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize << std::endl;
               }
               if(i == 1){
            	   	   *sfcwnd2->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize << std::endl;
               }
               if(i == 2){
                      *sfcwnd3->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize << std::endl;
               }
               if(i == 3){
                      *sfcwnd4->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize << std::endl;
               }
               if(i == 4){
                      *sfcwnd5->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize << std::endl;
               }
               if(i == 5){
                      *sfcwnd6->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize << std::endl;
               }
               if(i == 6){
                      *sfcwnd7->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize << std::endl;
               }
               if(i == 7){
                      *sfcwnd8->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize << std::endl;
               }
               if(i == 8){
                      *sfcwnd9->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize << std::endl;
               }
     }

/*
  uint32_t totalCwnd = 0;
  double iAverageCwnd = 0;
  int iCount = 0;
  ...
  iAverageCwnd = totalCwnd / 1.0 / iCount;
  m_tcb->m_cWnd = iAverageCwnd;

  *sfTotalCwnd->GetStream () << Simulator::Now ().GetSeconds () << " " << totalCwnd / iSegSize << "  " <<iAverageCwnd / iSegSize << std::endl;
  iCount = 0;
...
/*
  ...
  for (uint32_t i = 0; i < Maximum; i++)
  {
    for( SubflowList::const_iterator it = m_subflows[i].begin(); it != m_subflows[i].end(); it++ )
    {
      ...
      Ptr<MpTcpSubflow> sf = *it;
       {
    	  iTmpCwnd = sf->getSfWindow();          // Should be this all the time ?!
    	  if(iTmpCwnd > iMaxCwnd){
    		  iMaxCwnd = iTmpCwnd;
    	  }
...
/*
  int iCwnd = 0;
  for (uint32_t i = 0; i < 1; i++)  //Maximum = 0 : establish
  {
    for( SubflowList::const_iterator it = m_subflows[i].begin(); it != m_subflows[i].end(); it++ )
    {
    	  int iTmpsfid =  MpTcpSchedulerRoundRobin::iSfId;

    	  if(iTmpsfid < (int)GetNActiveSubflows()){
    		  std::cout<< "iTmpsfif = " << iTmpsfid << std::endl;
    		  Ptr<MpTcpSubflow> subflow = GetSubflow(iTmpsfid);
    		  if(subflow){
    			  iCwnd = subflow->getSfWindow();
    		  } else {
    			  iCwnd = m_tcb->m_cWnd;
    		  }
    	  }
...
//  int iCwnd = 0;
  uint32_t totalcwnd = compute_my_total_Cwnd ();
 // double alpha = calculate_alpha();

  m_tcb->m_cWnd = m_tcb->m_cWnd +  1.0 / totalcwnd;
...
uint32_t
MpTcpSocketBase::statisticalSfCwnd()
{
	  ...
	  for (int i = 0; i < (int) GetNActiveSubflows() ; i++ )
	      {
	        Ptr<MpTcpSubflow> sf = GetSubflow(i);
	        	   ...
	        	   if(i == 0){
	        		   	   *sfcwnd11->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize / 1.0 << std::endl;
	               }
	               if(i == 1){
	            	   	   *sfcwnd12->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize / 1.0 << std::endl;
	               }
	               if(i == 2){
	                      *sfcwnd13->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize / 1.0 << std::endl;
	               }
	               if(i == 3){
	                      *sfcwnd14->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize / 1.0 << std::endl;
	               }
	               if(i == 4){
	                      *sfcwnd15->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize / 1.0 << std::endl;
	               }
	               if(i == 5){
	                      *sfcwnd16->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize / 1.0 << std::endl;
	               }
	               if(i == 6){
	                      *sfcwnd17->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize / 1.0 << std::endl;
	               }
	               if(i == 7){
	                      *sfcwnd18->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize / 1.0 << std::endl;
	               }
	               if(i == 8){
	                      *sfcwnd19->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->Window() / iSegSize / 1.0 << std::endl;
	               }
	     }
...
uint32_t
MpTcpSocketBase::statisticSingleFlowCwnd(int sfid)
{

	Ptr<MpTcpSubflow> sf = GetSubflow(sfid);
	switch(sfid){
		case 0:
			  *sfcwnd11->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->getSfWindow() / iSegSize / 1.0 << std::endl;
			break;
		case 1:
			*sfcwnd12->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->getSfWindow() / iSegSize / 1.0 << std::endl;
			break;
		case 2:
			*sfcwnd13->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->getSfWindow() / iSegSize / 1.0 << std::endl;
			break;
		case 3:
			*sfcwnd14->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->getSfWindow() / iSegSize / 1.0 << std::endl;
			break;
		case 4:
			*sfcwnd15->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->getSfWindow() / iSegSize / 1.0 << std::endl;
			break;
		case 5:
			*sfcwnd16->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->getSfWindow() / iSegSize / 1.0 << std::endl;
			break;
		case 6:
			*sfcwnd17->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->getSfWindow() / iSegSize / 1.0 << std::endl;
			break;
		case 7:
			*sfcwnd18->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->getSfWindow() / iSegSize / 1.0 << std::endl;
			break;
		case 8:
			*sfcwnd19->GetStream () << Simulator::Now ().GetSeconds () << " " << sf->getSfWindow() / iSegSize / 1.0 << std::endl;
			break;
		default:
			break;
...
uint32_t
MpTcpSocketBase::coupledSingleFlowCwnd(int sfid)
{
	Ptr<MpTcpSubflow> sf = GetSubflow(sfid);
	//m_tcb->m_cWnd = sf->getSfWindow() * 5 / 6.0;

	int iNum = (int)GetNActiveSubflows();
	if(iNum == 1){
		Ptr<MpTcpSubflow> sf = GetSubflow(0);
		m_tcb->m_cWnd = sf->getSfWindow();
	} else if (iNum > 1){
		...
		if(sfid == 1){
			Ptr<MpTcpSubflow> sf = GetSubflow(1);
			m_tcb->m_cWnd = sf->getSfWindow();
		}
...
MpTcpSocketBase::calculate_alpha()
{
   ...
   for (int i = 0; i < (int) GetNActiveSubflows() ; i++ )
   {
	   ...
	   if(sf->m_rtt->GetEstimate ().GetSeconds () < 0.0000001){
		   continue;
	   }

  	   totalCwnd += sf->Window();
  	  // totalTime += sf->m_rtt->GetEstimate ().GetSeconds ();

  	   Time tmpTime = sf->m_rtt->GetEstimate ();
  	   double dRtt = tmpTime.GetSeconds ();

  	   double tmpValue = sf->Window() / (dRtt * dRtt);
  	   if(maxValue < tmpValue)
  		 maxValue = tmpValue;

  	   sumValue += sf->Window() / dRtt;

   }

   alpha = totalCwnd * maxValue /(sumValue * sumValue);
...
uint32_t
MpTcpSocketBase::compute_my_total_Cwnd(){


	  uint32_t totalCwnd = 0;

	  for (uint32_t i = 0; i < Maximum; i++)   //Maximum
	  {
	    for( SubflowList::const_iterator it = m_subflows[i].begin(); it != m_subflows[i].end(); it++ )
	    {
	      Ptr<MpTcpSubflow> sf = *it;
...
double
MpTcpSocketBase::calculateSmoothedCWND (int sFlowIdx)
{
	NS_LOG_FUNCTION_NOARGS ();
	 double totalCwnd = 0;
	 double avecwnd = 0;
	 ...
	 int iCount = 0;
	   ...
	   avecwnd = totalCwnd / iCount;

	   smoothCwnd = (avecwnd - GetSubflow(sFlowIdx)->Window()) * 0.1 + GetSubflow(sFlowIdx)->Window();

...
//	   LogComponentEnable("TcpOptionSack" , LOG_FUNCTION);
  ...
  Config::SetDefault("ns3::MpTcpSocketBase::PathManagerMode", EnumValue (MpTcpSocketBase::FullMesh));   //Default  nDiffPorts  FullMesh
...
// Later, we add IP addresses. 分配ip
  ...
  BulkSendHelper source ("ns3::TcpSocketFactory",InetSocketAddress (i1h0r1.GetAddress (1), port));

...
// We create the channels first without any IP addressing information 创建管道及连接
  ...
  p2ptx1.SetDeviceAttribute ("DataRate", StringValue ("10Mbps"));
  p2ptx1.SetChannelAttribute ("Delay", StringValue ("0.3ms"));
  NetDeviceContainer l0h0r0 = p2ptx1.Install (h0r0);
  //tchPfifoFastAccess.Install(l0h0r0);

   PointToPointHelper r2r11;
   r2r11.SetDeviceAttribute ("DataRate", StringValue ("10Mbps"));
   r2r11.SetChannelAttribute ("Delay", StringValue ("0.3ms"));
   NetDeviceContainer l1r0r1 = r2r11.Install (r0r1);

   PointToPointHelper r2r22;
   r2r22.SetDeviceAttribute ("DataRate", StringValue ("10Mbps"));
   r2r22.SetChannelAttribute ("Delay", StringValue ("0.3ms"));
   NetDeviceContainer l2r0r2 = r2r22.Install (r0r2);
   //tchPfifoFastAccess.Install(l0h0r0);

   PointToPointHelper r2r33;
   r2r33.SetDeviceAttribute ("DataRate", StringValue ("10Mbps"));
   r2r33.SetChannelAttribute ("Delay", StringValue ("10ms"));
   NetDeviceContainer l2r1r3 = r2r33.Install (r1r3);

  PointToPointHelper r2r44;
  r2r44.SetDeviceAttribute ("DataRate", StringValue ("10Mbps"));
  r2r44.SetChannelAttribute ("Delay", StringValue ("5ms"));
  //p2p.SetDeviceAttribute ("ReceiveErrorModel", PointerValue (&error_model));
  NetDeviceContainer l3r2r3 = r2r44.Install (r2r3);

  PointToPointHelper p2prx1;
  p2prx1.SetDeviceAttribute ("DataRate", StringValue ("10Mbps"));
  p2prx1.SetChannelAttribute ("Delay", StringValue ("0.3ms"));
  NetDeviceContainer l4h1r3 = p2prx1.Install (h1r3);
...
// Later, we add IP addresses. 分配ip
  ...
  Ipv4InterfaceContainer i1r0r1 = ipv4.Assign (l1r0r1);

  ipv4.SetBase ("10.1.3.0", "255.255.255.0");
  Ipv4InterfaceContainer i2r0r2 = ipv4.Assign (l2r0r2);

  ipv4.SetBase ("10.1.4.0", "255.255.255.0");
  Ipv4InterfaceContainer i3r1r3 = ipv4.Assign (l2r1r3);

  ipv4.SetBase ("10.1.5.0", "255.255.255.0");
  Ipv4InterfaceContainer i4h1r2 = ipv4.Assign (l3r2r3);

   ipv4.SetBase ("10.1.6.0", "255.255.255.0");
   Ipv4InterfaceContainer i5h1r3 = ipv4.Assign (l4h1r3);
...
// Create router nodes, initialize routing database and set up the routing
  ...
  BulkSendHelper source ("ns3::TcpSocketFactory",InetSocketAddress (i5h1r3.GetAddress (0), port));
